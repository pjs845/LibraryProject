				            ...
				            <nav aria-label="Page navigation example">
			                    <ul class="pagination pagination__custom justify-content-md-center flex-nowrap flex-md-wrap overflow-auto overflow-md-visble">
			                        	<c:if test="${map.rentalList.startpaging != 1}">
			                        			<li class="flex-shrink-0 flex-md-shrink-1 page-item"><a class="page-link" href="javascript:void(0);" onclick="clickPage(${map.rentalList.startpaging-1},6)">이전</a></li>
										</c:if>
				            ...
				            <nav aria-label="Page navigation example">
			                    <ul class="pagination pagination__custom justify-content-md-center flex-nowrap flex-md-wrap overflow-auto overflow-md-visble">
			                        	<c:if test="${map.requestList.startpaging != 1}">
			                        			<li class="flex-shrink-0 flex-md-shrink-1 page-item"><a class="page-link" href="javascript:void(0);" onclick="clickPage(${map.requestList.startpaging-1},6)">이전</a></li>
										</c:if>
                            ...
                            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3">
                                ...
                                <div class="col">
                                    <div>
                                        ...
                                        <div class="font-size-2 text-secondary-gray-700">
                                        	<a class="btn btn-primary-red btn-sm-wide transition-3d-hover" style="color:white;">찜 도서 삭제</a>                                            
                                        </div>
                                    </div>
                                </div>
                                </c:forEach>
				            ...
				            <nav aria-label="Page navigation example">
			                    <ul class="pagination pagination__custom justify-content-md-center flex-nowrap flex-md-wrap overflow-auto overflow-md-visble">
			                        	<c:if test="${map.favoriteList.startpaging != 1}">
			                        			<li class="flex-shrink-0 flex-md-shrink-1 page-item"><a class="page-link" href="javascript:void(0);" onclick="clickPage(${map.favoriteList.startpaging-1},6)">이전</a></li>
										</c:if>
