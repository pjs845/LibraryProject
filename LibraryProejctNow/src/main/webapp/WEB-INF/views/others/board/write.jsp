...
<body>
    ...
    <main id="content">
        <div class="py-3 py-lg-7">
            <h6 class="font-weight-medium font-size-7 text-center my-1">글쓰기</h6>
        </div>
        <div id="mainWrapper">
			...
			<article>		
				<div class="container" role="main">
					...
					<form name="form" id="form" role="form" method="post" action="/others/write.do">	
						<div class="mb-3">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" name="name" id="mem_num" placeholder="작성자 이름 받아와야함"/>
						</div>
						<div class="mb-3">
					...
					<button type="submit"  style="background: black; color:white; width: 100px; height: 40px;" id="btnSave" form="form">저장</button>
