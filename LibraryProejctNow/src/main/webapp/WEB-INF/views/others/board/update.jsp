...
<body>
    ...
    <main id="content">
        <div class="py-3 py-lg-7">
            <h6 class="font-weight-medium font-size-7 text-center my-1">수정하기</h6>
        </div>
        <div id="mainWrapper">
			...
			<article>		
				<div class="container" role="main">
					...
					<input type="hidden" name="seq" value="${bo.b_num}">
						...
						<input type="text" class="form-control" name="title" id="title" value="${bo.b_title}">	
						</div>
						<div class="mb-3">
							<label for="reg_id">작성자</label>					
							<input type="text" class="form-control" name="name" id="reg_id" value="${bo.mem_num}">
						</div>
						<div class="mb-3">
							<label for="content">내용</label>	
							<textarea class="form-control" rows="5" name="content" id="content">${bo.b_content}</textarea>	
						</div>	
						
						
					</form>	
					
					<button type="submit"  style="background: black; color:white; width: 100px; height: 40px;" id="btnSave" form="form">수정</button>
