...
<body>
    ...
    <main id="content">
        <div class="py-3 py-lg-7">
            <h6 class="font-weight-medium font-size-7 text-center my-1">게시글</h6>
        </div>
        <div id="mainWrapper">
			...
			<article>		
				<div class="container" role="main">
					...
					<input type="hidden" name="seq" value="${bo.b_num}">
						<div class="mb-3">
						<label for="title">제목</label>
						<input type="text" class="form-control" name="title" id="title" readonly value="${bo.b_title}">	
						</div>
						<div class="mb-3">
							<label for="reg_id">작성자</label>					
							<input type="text" class="form-control" name="name" id="reg_id" value="${bo.b_num}" readonly>
						</div>
						<div class="mb-3">
							<label for="content">내용</label>	
							<textarea class="form-control" rows="5" name="content" id="content" readonly >${bo.b_content}</textarea>	
						</div>	
						
						
					</form>	
					
					<button type="button"  style="background: black; color:white; width: 100px; height: 40px;" id="btnSave" onclick="location.href='/others/update?seq=${bo.b_num}'">수정</button>
					<button type="button" style="background: black; color:white; width: 100px; height: 40px;" id="btnList" onclick="location.href='/others/read.do'">목록</button>
					<button type="button" style="background: black; color:white; width: 100px; height: 40px;" id="btnDel" onclick="location.href='/others/del.do?seq=${bo.b_num}'">삭제</button>
                        ...
                        <div class="bg-white box-shadow-1 d-xl-flex">
                            ...
                            <!-- Nav Classic -->
                                <li class="flex-shrink-0 flex-md-shrink-1 nav-item">
                                    <a class="py-6 nav-link font-weight-medium" id="pills-four-example1-tab" data-toggle="pill" href="#pills-four-example1" role="tab" aria-controls="pills-four-example1" aria-selected="false">
                                        Reviews (0)
                                    </a>
                                </li>
                            </ul>
                        ...
                        <br><br>
                            ...
                            <c:forEach items="${list}" var="Review">
                                <li class="mb-4 pb-5 border-bottom">
                                    ...
                                    <br>
                                    <p class="mb-0 text-lh-md"style="text-align:left;">${Review.content}</p>
                                    <div class="text-gray-600 mb-4">${Review.regdate}</div>

                           </c:forEach>
                            </ul>

                            <h4 class="font-size-3 mb-4">댓글 작성</h4>
                            <form name="form" id="contentform" role="form" method="post" action="/others/create.do">  
                            <input type="hidden" name="seq" id="seq" value=""/>
        
                               <div class="js-form-message form-group mb-4">
                                   <label for="content" class="form-label text-dark h6 mb-3">댓글</label>
                                   <textarea name="content" id="content"class="form-control rounded-0 p-4" rows="7" id="descriptionTextarea" placeholder="댓글을 입력해주세요" required data-msg="Please enter your message." data-error-class="u-has-error" data-success-class="u-has-success"></textarea>
                                   <!--<c:if test="${empty id }">로그인이 필요합니다.</c:if>-->
                               <!-- </div>
                               <div class="form-group mb-5">
                                -->
                                   <label for="writer" class="form-label text-dark h6 mb-3">이름</label>
                                   <input type="text" class="form-control rounded-0 px-4" name="writer" id="writer" placeholder="3000자까지 적을 수 있습니다" aria-label="3000 characters remaining">
                               </div>
                               </form>
                               <div class="d-flex">
                                   <button type="submit"class="btn btn-dark btn-wide rounded-0 transition-3d-hover"  id="btnSave" form="contentform">댓글 달기</button>
                               </div>
                               <script>
