        ...
        <div class="mb-5 mb-lg-8 pb-xl-1">
                ...
                <div class="page-header border-bottom">
                    <div class="container">
                        <div class="d-md-flex justify-content-between align-items-center py-4">
                            <h1 class="page-title font-size-3 font-weight-medium m-0 text-lh-lg">대출관리 리스트</h1>
            ...
            <div class="container">
                <div class="row mb-lg-5 mb-xl-0">
                                ...
                                <script>
									jQuery(function($) {
										...
										$("#admin_search_button").click(function(e) {					// 메인 페이지 검색어 입력박스 옆 전송버튼 클릭시
											...
											$(location).attr('href', "/admin/rental/manage?catgo="+catgo+"&keyword="+keyword+"&cp=1&ps=10&searchModeStr=T");
											return false;
										});
									});
								</script>
                            ...
                            <div id="Categories" class="widget p-4 border">
                                <div id="Heading22">
                                    <a class="d-flex align-items-center justify-content-between collapse-link text-dark" href="#"
                                        ...
                                        <h3 class="title mb-0 font-weight-medium font-size-3">도서대출상황</h3>
                                ...
                                <div id="Collapse22" class="mt-4 collapse"
                                    ...
                                    data-parent="#SidebarAccordion">
                                    	<a class="form-group d-flex align-items-center justify-content-between font-size-2 text-lh-md mb-3" href="/admin/rental/manage?catgo=all&cp=1&ps=10&searchModeStr=T">
                                            <span class="text-dark">전체</span>
                                            <small class="text-gray-600"></small>
                                        </a>
                                        <a class="form-group d-flex align-items-center justify-content-between font-size-2 text-lh-md mb-3" href="/admin/rental/manage?catgo=wait&cp=1&ps=10&searchModeStr=T">
                                            <span class="text-dark">예약대기중</span>
                                            <small class="text-gray-600"></small>
                                        </a>
                                        <a class="form-group d-flex align-items-center justify-content-between font-size-2 text-lh-md mb-3" href="/admin/rental/manage?catgo=bor&cp=1&ps=10&searchModeStr=T">
                                            <span class="text-dark">대출중</span>
                                            <small class="text-gray-600"></small>
                                        </a>
                                        <a class="form-group d-flex align-items-center justify-content-between font-size-2 text-lh-md mb-3" href="/admin/rental/manage?catgo=return&cp=1&ps=10&searchModeStr=T">
                                            <span class="text-dark">반납완료</span>
                                            <small class="text-gray-600"></small>
                                        </a>                                    	
                                </div>
                            </div>
                    ...
                    <div class="col-lg-8 col-xl-9" id="ren_content">
                ...
                <script>                	                	                
	                function clickPage(cp, ps){
						...
						if(search!=""){ //검색했을 때
							...
							$(location).attr('href', "/admin/rental/manage?catgo="+catgo+"&cp="+cp+"&ps="+ps+"&keyword="+keyword+"&searchModeStr="+search);
						}else{ //검색 안했을 때							
							$(location).attr('href', "/admin/rental/manage?cp="+cp+"&ps="+ps);							
						}
                ...
                <script src="/js/rental_ok.js"></script>
                <script src="/js/rental_deny.js"></script>
                <script src="/js/rental_return.js"></script>
                <script src="/js/rental_del.js"></script>
                <script src="/js/rental_redraw.js"></script>
                <nav aria-label="Page navigation example">
                    <ul class="pagination pagination__custom justify-content-md-center flex-nowrap flex-md-wrap overflow-auto overflow-md-visble">
                        	<c:if test="${listResult.rblr.startpaging != 1}">
                        			<li class="flex-shrink-0 flex-md-shrink-1 page-item"><a class="page-link" href="javascript:void(0);" onclick="clickPage(${listResult.rblr.startpaging-1}, 10)">이전</a></li>
							</c:if>
						    <c:forEach begin="${listResult.rblr.startpaging}" end="${listResult.rblr.endpaging}" var="i">
						        <a href="list.do?ps=${ps}&cp=${i}">
						   			<c:choose>
						   			    <c:when test="${i==listResult.rblr.cp}">
						    ...
						    <c:if test="${listResult.rblr.endpaging != listResult.rblr.totalPageCount}">						
									<li class="flex-shrink-0 flex-md-shrink-1 page-item"><a class="page-link" href="javascript:void(0);" onclick="clickPage(${listResult.rblr.endpaging+1}, 10)">다음</a></li>
							</c:if>
                        </ul>
                </nav>
            </div>
