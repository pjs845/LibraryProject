                                            ...
                                            <div class="woocommerce-billing-fields">
                                                ...
                                                <div class="woocommerce-billing-fields__field-wrapper row">
                                                    <p class="col-lg-6 mb-4d75 form-row form-row-first validate-required woocommerce-invalid woocommerce-invalid-required-field" id="billing_first_name_field" data-priority="10">
                                                        ...
                                                        <input type="text" class="input-text form-control" name="book_title" id="book_title" placeholder="도서 제목을 입력해주세요" value="${listResult.libraryBook.book_title}" autocomplete="given-name" autofocus="autofocus" maxlength='500'>
                                                    </p>
                                                    ...
                                                    <p class="col-lg-6 mb-4d75 form-row form-row-last validate-required" id="billing_last_name_field" data-priority="20">
                                                        ...
                                                        <input type="text" class="input-text form-control" name="book_writer" id="book_writer" placeholder="도서 저자를 입력해주세요" value="${listResult.libraryBook.book_writer}" autocomplete="family-name" maxlength='200'>
                                                    </p>
                                                    ...
                                                    <p class="col-12 mb-4d75 form-row form-row-wide" id="billing_company_field" data-priority="30">
                                                        ...
                                                        <input type="text" class="input-text form-control" name="book_publisher" id="book_publisher" placeholder="도서 출판사를 입력해주세요" value="${listResult.libraryBook.book_publisher}" autocomplete="organization" maxlength='100'>
                                                    </p>
                                                    ...
                                                    <p class="col-12 mb-3 form-row form-row-wide address-field validate-required" id="billing_address_1_field" data-priority="50">
                                                        ...
                                                        <input type="text" class="input-text form-control" name="book_isbn" id="book_isbn" placeholder="도서 ISBN번호를 입력해주세요" value="${listResult.libraryBook.book_isbn}" autocomplete="address-line1" maxlength='20'>
                                                    </p>
