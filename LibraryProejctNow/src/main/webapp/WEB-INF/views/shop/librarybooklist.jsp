                    ...
                    <script>
						jQuery(function($) {
							...
							$("#search_button").click(function(e) {					// 메인 페이지 검색어 입력박스 옆 전송버튼 클릭시
								...
								$(location).attr('href', "/library/category/book?catgoId=0&keyword="+terms+"&page=1&show="+show);
								return false;
							});
						});
					</script>
                    ...
                    <div class="site-search ml-xl-0 ml-md-auto w-r-100 my-2 my-xl-0">
                        <form class="form-inline">
                            <div class="input-group">
                                ...
                                <input id="search" class="form-control bg-white-100 min-width-380 py-2d75 height-4 border-white-100" type="search" placeholder="제목검색 - 검색어를 입력하세요" aria-label="Search" autocomplete="off">
                            </div>
