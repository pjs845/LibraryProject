                ...
                <main id="main" class="site-main">
                    <article id="post-6" class="post-6 page type-page status-publish hentry">
                        <header class="entry-header space-top-2 space-bottom-1 mb-2">
                            <h4 class="entry-title font-size-7 text-center">도서 추가</h4>
                        </header>
                        <!-- .entry-header -->
                                ...
                                <form name="add" method="post" class="checkout woocommerce-checkout row mt-8" action="add.do" novalidate="novalidate" style="text-align:center;">
                                    <div class="col2-set col-md-6 col-lg-7 col-xl-8 mb-6 mb-md-0" id="customer_details" style="margin-right:auto; margin-left:auto;">
                                            ...
                                            <div class="woocommerce-billing-fields">
                                                ...
                                                <div class="woocommerce-billing-fields__field-wrapper row">
                                                    <p class="col-lg-6 mb-4d75 form-row form-row-first validate-required woocommerce-invalid woocommerce-invalid-required-field" id="billing_first_name_field" data-priority="10">
                                                        <label for="billing_first_name" class="form-label">DVD 제목<abbr class="required" title="required"></abbr></label>
                                                        <input type="text" class="input-text form-control" name="dvd_title" id="dvd_title" placeholder="DVD 제목을 입력해주세요" value="" autocomplete="given-name" autofocus="autofocus">
                                                    </p>

                                                    <p class="col-lg-6 mb-4d75 form-row form-row-last validate-required" id="billing_last_name_field" data-priority="20">
                                                        <label for="billing_last_name" class="form-label">감독<abbr class="required" title="required"></abbr></label>
                                                        <input type="text" class="input-text form-control" name="dvd_director" id="dvd_director" placeholder="감독을 입력해주세요" value="" autocomplete="family-name">
                                                    </p>

                                                    <p class="col-12 mb-4d75 form-row form-row-wide" id="billing_company_field" data-priority="30">
                                                        <label for="billing_company" class="form-label">내용</label>
                                                        <input type="text" class="input-text form-control" name="dvd_content" id="dvd_content" placeholder="내용을 입력해주세요" value="" autocomplete="organization">
                                                    </p>
                                                    <p class="col-12 mb-4d75 form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated" id="billing_country_field" data-priority="40">
                                                        <label for="billing_country" class="form-label">DVD 위치<abbr class="required" title="required"></abbr></label>
                                                    ...
                                                    <p class="col-12 mb-4d75 form-row form-row-wide address-field validate-required" id="billing_city_field" data-priority="70" data-o_class="form-row form-row-wide address-field validate-required">
                                                        <label for="billing_city" class="form-label">DVD 이미지 링크<abbr class="required" title="required"></abbr></label>
                                        ...
                                        <div class="form-row place-order">
                                            <input type="button" class="button alt btn btn-blue btn-block rounded-0 py-4" name="woocommerce_checkout_place_order" id="add_btn" value="도서추가" data-value="add" onclick="addbook()">                                                                                      
                                        </div>
                                    </div>                                    
                                </form>
                                <script>
