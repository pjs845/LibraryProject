                            ...
                            <ul class="nav pl-xl-4">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul id="bookDropdownMenu" class="dropdown-unfold dropdown-menu font-size-2 rounded-0 border-gray-900" aria-labelledby="bookDropdownInvoker">
                                        <li><a href="/" class="dropdown-item link-black-100">대출도서</a></li>
                                        <li><a href="/" class="dropdown-item link-black-100">신청도서</a></li>
                                        <li><a href="/" class="dropdown-item link-black-100">찜목록</a></li>
                                    </ul>
                                </li>
                                    ...
                                    <ul>
                                        ...
                                        <!-- <li class="dropdown-content">
                                            <a id="toc-toggle" onclick="openCloseToc_four()">도서관리</a>
                                            	<ul id="toc-contentfour">
		                                            <li><a href="/others/PBoard">신청도서</a></li>
		                                            <li><a href="/others/read.do">대출도서</a></li>
		                                            <li><a href="/others/read.do">찜 도서</a></li>
	                                            </ul>
                                        </li> -->
