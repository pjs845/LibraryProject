			      ...
			      <div  id="logs" class="chat-logs">
			      	...
			      	<div class="chat-msg user">
			       	...
			       	<div class="cm-msg-text">
			       		<center>안녕하세요 파스텔 도서관 입니다.</center>
			       		<center>[※ 회원제 사이트 입니다. ※]</center><br/>
			       		<input type="button" onclick="code_clicks()" class="log-menu" value="1. 도서관 소개"/>
