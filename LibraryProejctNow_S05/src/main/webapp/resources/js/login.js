...
function email_check(){
	...
	$.ajax({
		url:"http://13.209.64.211:8080/emailcheck.do",
		type:"post",
		dataType:"json",
...
function phone_check(){
	...
	$.ajax({
		url:"http://13.209.64.211:8080/phonecheck.do",
		type:"post",
		dataType:"json",
...
function id_checks(){
	...
	$.ajax({
		url:"http://13.209.64.211:8080/idcheck.do",
		type:"post",
		dataType:"json",
		data:{ mem_id:id },
		success: function(ic){
...
function memberPhoneChecks(){
	...
	if(!tel){
		...
		$.ajax({
			url : "http://13.209.64.211:8080/naverphone.do",
			type : "post",
			data : "tel=" + tel,
			dataType : "json",
...
function loginNaver(){
	$.ajax({
		url:'http://13.209.64.211:8080/naverlogin.do',
		type:'get',	
	}).done(function(res){
		//alert(res);
		//location.href = res;
...
function loginKakao(){
	$.ajax({
		url:'http://13.209.64.211:8080/kakaologin',
		type:'get',	
	}).done(function(res){
		alert(res);
		//location.href = res;
...
function find_phone_check(){
	...
	//alert(find_ok);
	$.ajax({
		url:"http://13.209.64.211:8080/findphonecheck.do",
		type:"post",
		dataType:"json",
		data:{ mem_phone:phone },
...
function find_phone_btn(){
	...
	if(!find_value){
		...
		$.ajax({
			url : "http://13.209.64.211:8080/findphone.do",
			type : "POST",
			data : "tel=" + tel,
			dataType : "json",
			success : function(data) {
...
function findaccount_check(){
	...
	$.ajax({
		url:'http://13.209.64.211:8080/findemails.do',
		type:'post',
...
function find_password_check(){
	...
	$.ajax({
		url:"http://13.209.64.211:8080/findpasswordcheck.do",
		type:"post",
		data:{ mem_email:mem_email },
		dataType:"json",
...
function find_email_btn() {
	...
	if(!e_check.test(email_value)){
		...
		$.ajax({
			type : 'get',
			url : 'http://13.209.64.211:8080/mailCheck', 
...
function find_pass_check(){
	...
	$.ajax({
		url:'http://13.209.64.211:8080/passCheck.do',
		type:'post',
		data:{'mem_email':mem_email},
		//dataType:'json',
		success: function(data){
...
function pass_check() {
	...
	$.ajax({
		url:'http://13.209.64.211:8080/deletepasswordcheck',
		type:'post',
...
function go(){
	...
	if(!confirm("탙퇴하시겠습니까?")){
		...
		alert("탈퇴완료[네이버]");
		location.href= "http://13.209.64.211:8080/naverResign.do";
		deleteBtn.submit();
...
window.addEventListener('unload', (e)=>{
	console.log("close");
	$.ajax({
		url:'http://13.209.64.211:8080/logouttest',
		type:'get',
