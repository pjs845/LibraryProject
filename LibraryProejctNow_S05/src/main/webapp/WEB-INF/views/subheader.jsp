...
<body>
   <header id="site-header" class="site-header__v1">
		                    ...
		                    <c:otherwise>
		                    	 <li class="nav-item">
		                            ...
		                            <a id="sidebarNavToggler" href="javascript:;" role="button" class="nav-link link-black-100"
		                                ...
		                                data-unfold-duration="500">
		                                <!-- <i class="glph-icon flaticon-user"></i> -->
		                                <i class="fa-solid fa-user" style="color:#0e306c;font-size:20px;"></i>
		                            </a>
		                            <!-- End Account Sidebar Toggle Button -->
		                        </li>
        ...
        <div class="masthead border-bottom position-relative" style="margin-bottom: -1px;background: linear-gradient(#f1fff3, #efefff);">
                ...
                <div class="d-flex align-items-center position-relative flex-wrap">
                    ...
                    <div class="site-navigation mr-auto d-none d-xl-block">
                        <ul class="nav">
                            ...
                            <li class="nav-item dropdown">
                                    <a id="bookDropdownInvoker" href="#" class="dropdown-toggle nav-link link-black-100 mx-4 px-0 py-5 font-weight-medium d-flex align-items-center"
                                        aria-haspopup="true"
                                        aria-expanded="false"
                                        data-unfold-event="hover"
