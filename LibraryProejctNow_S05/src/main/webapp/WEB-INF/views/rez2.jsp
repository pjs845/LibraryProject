...
<body class="right-sidebar woocommerce-checkout">
    ...
    <div class="page-header border-bottom">
        <div class="container">
            <div class="d-md-flex justify-content-between align-items-center py-4">
                <h1 class="page-title font-size-3 font-weight-medium m-0 text-lh-lg">Reservation</h1>
                <nav class="woocommerce-breadcrumb font-size-2">
                    <a href="/" class="h-primary">Home</a>
                    <span class="breadcrumb-separator mx-1"><i class="fas fa-angle-right"></i></span>
                    <a href="#" class="h-primary">Reservation</a>
    ...
    <div class="">
						             ...
						             <br><br>
						             <div id="font" style="color:#222a23; left: 40%; width: 20%; height:20%; bottom: 220px; font-size: 1.8em; font-weight: bold; position: absolute">열람실 예약</div>
						          <!-- <div style="color:black; bottom: 263px; font-size: 1.8em; font-weight: bold;text-align:center; position: relative">열람실 예약</div></h6> -->
						        </div>
