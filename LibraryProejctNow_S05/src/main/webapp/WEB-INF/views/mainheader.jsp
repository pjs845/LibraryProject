            ...
            <div class="container pt-3 pt-md-4 pb-3 pb-md-5">
                <div class="d-flex align-items-center position-relative flex-wrap">
                    ...
                    <div class="site-branding pr-7">
                        ...
                        <img alt="" width="150" height="75" src="https://ifh.cc/g/syLZZr.png">
                        ...
                        <form action="/search/book" class="form-inline my-2 my-xl-0">
                            <div class="input-group input-group-borderless w-100">
                                <div class="input-group-prepend border-right mr-0 d-none d-xl-block">
                                    <select id="selected_type" class="custom-select pr-7 pl-4 rounded-right-0 height-5 shadow-none border-0 text-dark bg-gray-200 bg-focus__1" id="inputGroupSelect01" style="font-family: 'SUIT-Medium';">
                    ...
                    <div class="d-flex align-items-center mt-lg-3 mt-xl-0">                                           
                        ...
                        <!-- End Account Sidebar Toggle Button -->
	                             ...
	                             <a id="sidebarNavToggler" href="" role="button"
			                            ...
			                            data-unfold-duration="500">
			                            <div class="d-flex align-items-center text-white font-size-2 text-lh-sm">
			                                <i class="fa-solid fa-user" style="color:#0a184a;font-size:25px;"></i>
		                                <div class="ml-2 d-none d-lg-block">
                    ...
                    <div class="d-flex align-items-center justify-content-center position-relative" style="font-family: 'SUIT-Medium';">
                        <div class="site-navigation mr-auto d-none d-xl-block">
                            <ul class="nav pl-xl-4">
                                ...
                                <li class="nav-item dropdown">
                                    <a id="bookDropdownInvoker" href="#" class="dropdown-toggle nav-link link-black-100 mx-3 px-0 py-3 font-size-2 font-weight-medium d-flex align-items-center"
                                        aria-haspopup="true"
                                        aria-expanded="false"
                                        data-unfold-event="hover"
                                        data-unfold-target="#bookDropdownMenu"
                                        data-unfold-type="css-animation"
                                        data-unfold-duration="200"
                                        data-unfold-delay="50"
                                        data-unfold-hide-on-scroll="true"
                                        data-unfold-animation-in="slideInUp"
                                        data-unfold-animation-out="fadeOut">
                                       	도서관리&nbsp;<i class="fa-solid fa-chevron-down"></i>
                                    </a>
                                    <ul id="bookDropdownMenu" class="dropdown-unfold dropdown-menu font-size-2 rounded-0 border-gray-900" aria-labelledby="bookDropdownInvoker">
                                    <c:choose>
                                    	<c:when test="${not empty member }">
                                    		<li><a href="/bookManage/library?mem_num=${member.mem_num}&category=1" class="dropdown-item link-black-100">대출도서</a></li>
                                        	<li><a href="/bookManage/library?mem_num=${member.mem_num}&category=2" class="dropdown-item link-black-100">신청도서</a></li>
                                        	<li><a href="/bookManage/library?mem_num=${member.mem_num}&category=3" class="dropdown-item link-black-100">찜목록</a></li>
                                    	</c:when>
                                    	<c:otherwise>
                                    		<li><a href="/bookManage/library?mem_num=0&category=1" class="dropdown-item link-black-100">대출도서</a></li>
                                        	<li><a href="/bookManage/library?mem_num=0&category=2" class="dropdown-item link-black-100">신청도서</a></li>
                                        	<li><a href="/bookManage/library?mem_num=0&category=3" class="dropdown-item link-black-100">찜목록</a></li>
                                    	</c:otherwise>
                                    </c:choose>                                        
                                    </ul>
                                </li>
                                ...
                                <li class="nav-item dropdown">
                                    <a href="http://13.209.64.211:80" class="nav-link link-black-100 mx-3 px-0 py-3 font-size-2 font-weight-medium d-flex align-items-center">
                            ...
                            <div class="border-bottom">
                                <div class="zeynep pt-4" >
                                    <ul>
                                       ...
                                       <li class="dropdown-content">
                                            <a id="toc-toggle" onclick="openCloseToc_four()">도서관리</a>
                                            	<ul id="toc-contentfour" style="display: none;">
		                                            <c:choose>
                                            			<c:when test="${not empty member}">
                                            				<li><a href="/bookManage/library?mem_num=${member.mem_num}&category=1">대출도서</a></li>
		                                            		<li><a href="/bookManage/library?mem_num=${member.mem_num}&category=2">신청도서</a></li>
		                                            		<li><a href="/bookManage/library?mem_num=${member.mem_num}&category=3">찜 도서</a></li>
                                            			</c:when>
                                            			<c:otherwise>
                                            				<li><a href="/bookManage/library?mem_num=0&category=1">대출도서</a></li>
		                                            		<li><a href="/bookManage/library?mem_num=0&category=2">신청도서</a></li>
		                                            		<li><a href="/bookManage/library?mem_num=0&category=3">찜 도서</a></li>
                                            			</c:otherwise>
                                            		</c:choose>	
	                                            </ul>
                                        </li>
                                        <li class="dropdown-content">
                                            <a id="toc-toggle" href="http://13.209.64.211:80" data-submenu="computers">독서클럽 </a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
