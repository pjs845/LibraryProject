...
public interface BookReviewsRepository extends JpaRepository<BookReviews, Long> {
	...
	@Transactional
	@Modifying
	@Query(value = "insert into BOOK_REVIEWS values(BOOK_REVIEWS_SEQ.nextval, :book_num, :mem_num, :brs_content, :brs_rating, 0, 0, CURRENT_DATE, CURRENT_DATE)", nativeQuery = true)
	...
	@Transactional
	@Modifying
	@Query(value = "insert into book_reviews_log VALUES(BOOK_REVIEWS_LOG_SEQ.nextval, :brs_num, :mem_num, 0, 0, CURRENT_DATE, CURRENT_DATE)", nativeQuery = true)
